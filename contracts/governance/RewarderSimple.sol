...
contract RewarderSimple is IRewarder {
    ...
    constructor(
        ...
        require(
            _rewardToken != address(0) && _MASTERCHEF_V2 != address(0),
    ...
    function onReward(
        ...
        uint256 pendingReward = rewardAmount.mul(rewardMultiplier) /
        ...
        returns (IERC20[] memory rewardTokens, uint256[] memory rewardAmounts)
    {
        ...
        _rewardAmounts[0] =
            rewardAmount.mul(rewardMultiplier) /
            REWARD_TOKEN_DIVISOR;
